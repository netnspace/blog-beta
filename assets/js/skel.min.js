    ...
    var t = {
        ...
        extend: function(e, n) {
            t.iterate(n, function(i) {
                ...
                t.extend(e[i], n[i])) : "object" == typeof n[i] ? ("object" != typeof e[i] && (e[i] = {}),
        ...
        detach: function(t) {
            var e = t.element;
            return t.permanent || !e.parentNode || e.parentNode && !e.parentNode.tagName ? !1 : (e.parentNode.removeChild(e),
            !0)
        },
        ...
        initMethods: function() {
            ...
            : t.matchesMedia = function(t) {
                ...
                e = 0; e < i.length; e++)
                    ...
                    a = n.split(/:\s+/),
                    2 == a.length && (r[a[0].replace(/^\s+|\s+$/g, "")] = parseInt(a[1]),
                    o = !0));
                if (!o)
                    return !1;
